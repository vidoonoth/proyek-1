<?php 
include '../../php/ReadDataUsulan.php'
?>
...
<html lang="en">
  <head>
    ...
    <title>Data Pengusulan</title>
    <link rel="stylesheet" href="../../css/admin/DataPengusulan.css" />
    <link
      ...
      <div class="main-content">
        ...
        <table>
          ...
          <tr>
            ...
            <td><?= $rows['kategori'] ?></td>
            <td>
              <a href="EditStatus.php?id_usulan=<?= $rows['id_usulan'] ?>">edit</a>
              <a href="HapusUsulan.php?id_usulan=<?= $rows['id_usulan'] ?>">hapus</a>
            </td>
