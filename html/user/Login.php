...
if (isset($_POST['SignIn'])){
  ...
  $sql = "SELECT * FROM pengusul WHERE username_pengusul='$username' AND password_pengusul='$password'";
  $query = $con->query($sql);

  if ($query -> num_rows > 0 ){
    $isi = mysqli_fetch_assoc($query);
    $_SESSION["login"] = true;
    $_SESSION["id"] = $isi['id_pengusul'];
      ...
      <div class="main">
        ...
        <form action="" method="post">
            ...
            <div class="registrasi">
              <a href="../../html/user/Register.php">belum punya akun?</a>
            </div>
            <li>
